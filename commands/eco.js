...
exports.flip_coin = function (args, msg, PREFIX) {
    db.User.findOrCreate({id: msg.author.id}).then(user => {
...
exports.balance = function (args, msg, PREFIX) {
    ...
    }); else db.User.findOrCreate({id: msg.author.id}).then(user => {
...
exports.daily = function (args, msg, PREFIX) {
    ...
    if (args[0] === "count") {
        return db.User.findOrCreate({id: msg.author.id}).then(user => {
